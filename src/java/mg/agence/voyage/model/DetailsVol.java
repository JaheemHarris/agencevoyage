...
@Entity
@Table(name = "view_details_vol")
public class DetailsVol extends BaseModel{
    ...
    public DetailsVol(int idAvion, String modele, int nombrePlaceAffaire, int nombbrePlaceEco, String lieuDepart, String lieuArrivee, int duree, String dateDepart, String heureDepart) {
