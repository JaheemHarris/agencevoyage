 ...
 */
package mg.agence.voyage.dao;

import java.text.SimpleDateFormat;
import java.util.ArrayList;
import java.util.Date;
import java.util.List;
import mg.agence.voyage.model.BaseModel;
...
public class HibernateDAO implements InterfaceDAO{
    ...
    @Override
    public List findByQuery(String query, BaseModel baseModel) throws Exception {
        List resultList = new ArrayList();
        Session session = null;
        try{
            session = sessionFactory.openSession();
            SQLQuery sqlQuery = session.createSQLQuery(query);
            sqlQuery.addEntity(baseModel.getClass());
